...
export default function AuthLayout() {
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-neutral-950 transition-colors duration-200">
      {/* Left Pane - Forms */}
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-black justify-center items-center p-12 border-l border-slate-800">
        {/* Decorative Gradients */}
        <div className="absolute top-[-20%] left-[-20%] w-[80%] h-[80%] rounded-full bg-orange-500/10 blur-[120px]" />
        <div className="absolute bottom-[-20%] right-[-20%] w-[80%] h-[80%] rounded-full bg-amber-500/10 blur-[120px]" />
        <div className="absolute top-[30%] right-[10%] w-[300px] h-[300px] rounded-full bg-orange-500/5 blur-[100px]" />

        <div className="relative z-10 max-w-lg space-y-12">
          {/* Brand Logo */}
          <div className="flex items-center space-x-3 text-white">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-orange-500 to-amber-600 flex items-center justify-center shadow-lg shadow-orange-500/30">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl font-extrabold tracking-tight text-white leading-tight font-display">
              ...
              <span className="bg-gradient-to-r from-orange-450 via-amber-400 to-yellow-500 bg-clip-text text-transparent">
                xavfsiz boshqaring
              </span>
            </h1>
