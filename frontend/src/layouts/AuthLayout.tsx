...
export default function AuthLayout() {
  ...
  return (
    <div className="min-h-screen flex bg-[#F4F4F7] dark:bg-[#0B0B0E] text-slate-900 dark:text-slate-100 transition-colors duration-200">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-white dark:bg-[#16161E] justify-center items-center p-12 border-l border-amber-500/20 dark:border-amber-500/15">
        ...
        <div className="relative z-10 max-w-lg space-y-12">
          ...
          <div className="flex items-center space-x-3 text-slate-900 dark:text-white">
            <div className="h-10 w-10 rounded-xl gold-gradient flex items-center justify-center shadow-md shadow-amber-500/20">
              <Wallet className="h-5.5 w-5.5 text-white dark:text-[#0B0B0E]" />
            </div>
          ...
          <div className="space-y-6">
            <h1 className="text-4xl font-black tracking-tight text-slate-900 dark:text-white leading-tight font-display">
          ...
          <div className="grid grid-cols-2 gap-6 pt-4">
            <div className="p-5 rounded-2xl bg-slate-50 dark:bg-[#0B0B0E]/60 border border-amber-500/20 dark:border-amber-500/15 backdrop-blur-sm space-y-3 shadow-sm">
              <div className="h-9 w-9 rounded-lg bg-[#F59E0B]/15 flex items-center justify-center text-[#D97706] dark:text-[#F59E0B]">
                <BarChart3 className="h-5 w-5" />
              </div>
              <h3 className="font-bold text-slate-900 dark:text-white">Dinamik Grafikar</h3>
            ...
            <div className="p-5 rounded-2xl bg-slate-50 dark:bg-[#0B0B0E]/60 border border-amber-500/20 dark:border-amber-500/15 backdrop-blur-sm space-y-3 shadow-sm">
              <div className="h-9 w-9 rounded-lg bg-[#FCD34D]/15 flex items-center justify-center text-[#D97706] dark:text-[#FCD34D]">
                <TrendingUp className="h-5 w-5" />
              </div>
              <h3 className="font-bold text-slate-900 dark:text-white">Byudjet Nazorati</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-normal">
          ...
          <div className="p-5 rounded-2xl glass-gold border border-amber-500/25 shadow-xl space-y-3">
            <div className="flex items-center space-x-1 text-[#D97706] dark:text-[#FCD34D]">
              <Shield className="h-4 w-4 fill-[#F59E0B]/20" />
              <span className="text-xs font-bold uppercase tracking-wider text-[#D97706] dark:text-[#FCD34D]">Xavfsiz &amp; Ishonchli</span>
            </div>
