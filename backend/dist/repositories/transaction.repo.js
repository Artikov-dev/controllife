...
class TransactionRepository {
    static async findById(id, userId) {
        const res = await (0, db_1.query)(`SELECT t.*, c.name as category_name, c.icon as category_icon, c.color as category_color
       FROM transactions t
    ...
    static async create(transaction) {
        const res = await (0, db_1.query)(`INSERT INTO transactions (title, amount, description, transaction_date, type, category_id, user_id)
    ...
    static async update(id, userId, updates) {
        ...
        const res = await (0, db_1.query)(`UPDATE transactions
    ...
    static async delete(id, userId) {
        const res = await (0, db_1.query)('DELETE FROM transactions WHERE id = $1 AND user_id = $2', [id, userId]);
    ...
    static async countAll(userId, filters) {
    ...
    static async getSummaryStats(userId) {
        const res = await (0, db_1.query)(`SELECT 
    ...
    static async getMonthlyTrend(userId, limit = 6) {
        const res = await (0, db_1.query)(`SELECT 
